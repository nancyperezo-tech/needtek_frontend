...
export default function SolucionesPage() {
  ...
  <p className="text-base sm:text-lg md:text-2xl text-center text-[#2A2C2E] mb-6 md:mb-10 max-w-xl mx-auto">Diseñamos estrategias a la medida de tu organización, integrando tecnología, cultura y modelos operativos para mejorar la productividad e impulsar el crecimiento.</p>
